      ...
      <h2 className="text-teal font-serif">Important Dates:</h2>
        ...
        <p className="pl-4">
          <ul className="sm:list-reset">
            <li><strong className="text-grey-darker">Submissions:</strong> <strike className="text-red-light"> June 2, 2019</strike> <strong className="text-purple-light text-lg">June 23, 2019</strong> (<a class="no-underline hover:font-bold text-purple-light" href="https://en.wikipedia.org/wiki/Anywhere_on_Earth">23:59 AoE</a>)</li>
