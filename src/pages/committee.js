...
const CommitteePage = () => (
    ...
    <div className="md:w-2/3 md:mr-8">
      ...
      <p className="font-serif leading-loose pl-4 text-justify">
        ...
        <ul>
          <li>Elgar Fleisch (ETH Zurich / St. Gallen, Switzerland)</li>
          <li>Alexander Ilic (Univ of St Gallen, Switzerland)</li>
          <li>Christian Floerkemeier (MIT / ETH Zurich, U.S.A/Switzerland)</li>
          <li>Marc Langheinrich (Università della Svizzera italiana – USI, Switzerland)</li>
