    ...
    <div className="flex flex-col md:flex-row items-center">
      <div className="md:w-3/3 md:mr-8">
        <p className="border-l-4 border-grey-darkest font-serif leading-loose pl-4 text-justify">
          ...
          <strong>Address:</strong> Avenida de las universidades, 24 48007 Bilbao (Spain) (<a href="https://www.google.es/maps/place/University+of+Deusto/@43.2712452,-2.9385576,15z/data=!4m2!3m1!1s0x0:0x6ea1bd3e8bae3141?ved=2ahUKEwiNnKbD7eDfAhXIxIUKHQ8DCAUQ_BIwDnoECAYQCA">Google Maps</a>)  
        </p>
        <br />
        <img src={Deusto} />
